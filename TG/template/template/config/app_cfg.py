# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in template.
...
import template
from template import model, lib
...
base_config.update_blueprint({
    ...
    'DBSession': template.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "0fb42c90-a4c2-439f-98ed-0dac845937e5",
